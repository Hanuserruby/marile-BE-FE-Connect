...
import { MoreVertical, X, ShoppingBag, Printer } from 'lucide-react';
        ...
        {selectedTrx && (
          <div className="history-modal-overlay" onClick={() => setSelectedTrx(null)}>
            <div className="history-modal-content" onClick={(e) => e.stopPropagation()}>
              <button className="history-modal-close" onClick={() => setSelectedTrx(null)}>
                <X size={20} />
              </button>
              ...
              <div className="history-modal-body">
                <div className="info-grid">
                  ...
                  <div className="info-item">
                    <label>Kasir</label>
                    <p>{selectedTrx.cashier?.name || '-'}</p>
                  </div>
                  <div className="info-item text-right">
                    <label>Status</label>
                    <p>{selectedTrx.status === 'completed' ? 'Selesai' : 'Dibatalkan'}</p>
                  </div>
                </div>
